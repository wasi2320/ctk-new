...
const AiDifferentiateSection = () => {
  return (
    <section className="md:px-28 px-4 py-12 bg-[url('/Images/Differentiate_Bg.webp')] bg-cover bg-center bg-no-repeat flex flex-col md:flex-row justify-between items-center text-white gap-12">
      <div className="md:w-[45%]">
        ...
        <Image
          ...
          alt="Custom AI and machine learning solutions"
          width={260}
          height={260}

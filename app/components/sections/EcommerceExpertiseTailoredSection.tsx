...
const EcommerceExpertiseTailoredSection = ({
  heading,
}: EcommerceExpertiseTailoredSectionProps) => {
  return (
      ...
      <div className="flex flex-col md:flex-row gap-24 justify-between items-center">
        ...
        <div className="text-center">
          ...
          <p className="text-sm nunito-extraLight">
            Rapid expansion driven by digital-first <br></br> shopping habits.
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-sm nunito-extraLight">
            Growth in retail technology <br></br> innovators.
          </p>
        </div>
      </div>
    </section>

...
const FinOpsDifferentiateSection = () => {
  return (
    <section className="md:px-28 px-4 pb-24 pt-12 bg-[url('/Images/Differentiate_Bg.webp')] bg-cover bg-center bg-no-repeat text-white">
      ...
      <p className="md:text-2xl text-white/70 text-center md:text-start">
      ...
      <div className="grid md:grid-cols-4 mt-16 gap-10">
        {FINOPS_DIFFERENTIATE_SECTION.cards.map((card, index) => (
          <div key={index} className="flex flex-col items-center gap-4">
            ...
            <p className="md:text-lg text-sm text-white/70 text-center">
              {card.description}
            </p>
          </div>
        ))}

    ...
    <section
        ...
        <div className="relative flex flex-col md:flex-row justify-between items-center md:gap-50 gap-20">
            ...
            <div className="bg-[#f9f8f8] md:p-20 p-12 rounded-xl shadow-2xl w-full md:w-3/4">
                <h2 className="md:text-5xl text-4xl mb-12 font-medium font-Nunito">Get in Touch</h2>
                ...
                <form className="space-y-6">
                    ...
                    <label className="flex items-center gap-2 cursor-pointer">
                        <img src="/Images/upload-icon.png" alt="Upload" className="w-4 h-4" />
                        <span className="text-gray-800 font-semibold font-Nunito">Upload file</span>
            ...
            <div className="w-full md:w-1/4 text-center md:text-left flex flex-col gap-8 font-Nunito border-l-2 border-gray-700 pl-6">
                <div>
                    ...
                    <p className="text-sm font-semibold">
                        432 Cherry DR, Troy,<br />
                        Michigan<br />
                        48083 United States<br />
                        (248) 823-3200
                    </p>
                </div>
            ...
            <div>
                ...
                <p className="text-sm font-semibold">C2K@gmail.com</p>
            </div>

            <div>
                <h4 className="font-semibold text-2xl mb-2">Phone Number:</h4>
                <p className="text-sm font-semibold">+73638383912</p>
            </div>
            ...
            <div>
                ...
                <div className="flex md:align-start md:justify-start align-center justify-center gap-4">
                    <a href="#">
                        <img src="/Images/fb-link.png" alt="Facebook" className="w-12 h-12 object-contain" />
                    </a>
                    <a href="#">
                        <img src="/Images/insta-link.png" alt="Instagram" className="w-12 h-12 object-contain" />
                    </a>
                    <a href="#">
                        <img src="/Images/link-link.png" alt="LinkedIn" className="w-12 h-12 object-contain" />
                    </a>
                </div>
            </div>
            </div>

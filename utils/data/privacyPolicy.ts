  ...
  sections: [
    {
      ...
      content: `The website ("Site") for CodeToCloud ("CodeToCloud", "We", "Our", "Us" or "Company") was created to provide cloud solutions, software development services, and other related services (the "Services"). The privacy of our Site visitors ("you," "your," or "user") is important to us, and in order to protect your personal information, we have implemented the following Privacy Policy with provisions that apply to the collection of data by CodeToCloud, its subsidiaries, and its affiliates.Our Privacy Policy discloses the type and nature of information we collect and how we use it, as well as the choices you can make about the way your information is collected and used. We also explain how any requests for personal or personally identifiable information will be used. By exploring and using CodeToCloud's Site and/or Services, and by submitting information to CodeToCloud, you signify acceptance to the terms of our Privacy Policy.If you have questions or concerns regarding this statement, you should first contact us at info@codetocloud.com.`,
    },
    {
      heading: "Updates and Changes to the Privacy Policy",
      content: `In the event of a change in this policy, a revised Privacy Policy will be posted to our Website, and the "Updated" date will be changed. If the revised Privacy Policy contains a material change to how we collect or use personal information, notice of the change will be emailed to you or posted on the Website's home page.
...
Please revisit this page to familiarize yourself with changes to the Privacy Policy. You agree to accept posting of a revised Privacy Policy as described herein as actual notice to you of such revised Privacy Policy. Your continued use of the Services after such posting constitutes the collection and use of your information as described in the then-current Privacy Policy.`,
    },
    {
      ...
      content: `We are required by law, regulation, or securities reasons to ask for certain personal information in order to provide our Services to you. CodeToCloud makes commercially reasonable best efforts to maintain the confidentiality, integrity, and security of our clients' personal information.
...
• Website from which our domain is accessed and website usage information
...
Keeping client information secure, and using it only as our Users want us to, are matters of principle for all of us at CodeToCloud. With this in mind, here is our commitment to each and every User:

• Except as you may otherwise expressly approve, we will limit the collection and use of client and user information to what we believe would be useful to service your accounts, administer our business, or to tell you about our Services;
...
We or our service providers may also collect web surfing data related to your use of the Services (e.g., information regarding which of our web pages you access, the frequency of such access, and your product and service preferences). This may be accomplished by using cookies, web beacons, page tags, or similar tools. Such web surfing data may include your Internet Protocol (IP) address, browser type, internet service provider (ISP), referring or exit pages, clickstream data, operating system, and the dates and times that you visit the Website. Web surfing data and similar information may be used for administrative purposes; to assess the usage, value, and performance of our online products and services; and to improve your experience with the Services.`,
    },
    {
      ...
      content: `Please contact CodeToCloud with any questions or comments about this Privacy Policy, your personal information, or your choices with regards to our collection and use of your personal information, email at info@codetocloud.com.
...
For citizens of the European Union and United States, please contact info@codetocloud.com for requests and inquiries regarding the data retained and managed by this portal and your rights to be forgotten related to the General Data Protection Regulation (GDPR).`,
    },
  ],
};
